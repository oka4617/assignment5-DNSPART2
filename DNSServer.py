...
dns_records = {
    ...
    # nyu.edu required records
    'nyu.edu.': {
        dns.rdatatype.A: '192.168.1.106',
        # Keep as string-cast of encrypted bytes
...
def run_dns_server():
    # UDP socket (DNS uses UDP for most queries)
    server_socket = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)

    # FIX for macOS Errno 49:
    # bind to localhost instead of a hardcoded LAN IP your Mac may not have.
